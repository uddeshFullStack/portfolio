        ...
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    ...
                    initial="hidden"
                    animate="visible"
                    className='pb-16 text-6xl font-thin tracking-tighter lg:mt:16 lg:text-6xl'>
                        Uddeshy Kr Bhagat
                    </motion.h1>
                    <motion.span 
                    ...
                    initial="hidden"
                    animate="visible" 
                    className='my-2 max-w-2xl py-6 font-light tracking-tighter'>{HERO_CONTENT}
                    </motion.p>
                </div>
            </div>
            <div className='"w-full lg:w-1/2 lg:p-8'>
                <div className='flex justify-center' style={{ width: '40%'}}>
                    ...
                    src={photos} className='rounded-full mix-blend-hard-light' alt='uddesh'/>
                </div>
            </div>
        </div>
    </div>
